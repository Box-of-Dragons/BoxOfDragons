...
function render_site_header(string $currentPath = '/'): string {
    ...
    return '<header class="site-header">'
        ...
        . '<a class="project-link project-link--github" href="https://github.com/Box-of-Dragons/CraftCms" target="_blank" rel="noopener noreferrer" aria-label="Open the project on GitHub">'
        . github_icon_svg() . '<span>GitHub</span></a>'
        . '<a class="project-link project-link--gitlab" href="https://gitlab.com/structured-chaos/craftcms" target="_blank" rel="noopener noreferrer" aria-label="Open the project on GitLab">'
